...
namespace M05_UF3_P3_Frogger
{
    public class Lane
    {
        ...
        {
            this.posY = posY;//Posicion de la linea
...
//Este objeto nos dibuja todo el mapa introduciendo las distintas lineas que queremos dibujar en una lista
